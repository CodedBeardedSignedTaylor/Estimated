...
# Constructor
    ...
    def test100_010_ShouldConstructPythonScriptFullPath(self):
        script = PythonScript.PythonScript(fileName = "C:/Users/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationComments.py")
        self.assertIsInstance(script, PythonScript.PythonScript)
    
    def test100_020_ShouldConstructPythonScriptRelativePath(self):
        self.assertIsInstance(PythonScript.PythonScript(fileName = "../../CA03Validation/validationComments.py"), PythonScript.PythonScript)
    ...
    def test100_950_ShouldRaiseExceptionOnFilenameNotExists(self):
        expectedString = "PythonScript.__init__:"
        try:
            myPythonScript = PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationO.py")                                                
            self.fail("exception was not raised")                    
        except ValueError as raisedException:                                      
            diagnosticString = raisedException.args[0]                                   
            self.assertEquals(expectedString, diagnosticString[0:len(expectedString)]) 
...
# getFileName
    ...
    def test200_020_ShouldReturnFilenameFromRelativePath(self):
        ...
        self.assertEquals(itemToCompare, PythonScript.PythonScript("../../CA03Validation/validationComments.py").getFileName())
    
    def test200_030_ShouldReturnFilenameFromAbsolutePath(self):
        itemToCompare = "PythonScriptTest.py"
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/test/testFiles/test.py").getFileName())
    
# getFilePath
    #300_0xx ... happy
    def test300_010_ShouldReturnFilepath(self):
        itemToCompare = "/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/"
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationComments.py").getFilePath())
    
# countLoc
    #400_0xx ... happy
    def test400_010_ShouldReturnLocCountValidationComments(self):
        itemToCompare = 0
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationComments.py").countLoc())
    
    def test400_020_ShouldReturnLocCountValidationDocstrings(self):
        itemToCompare = 15
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationDocstrings.py").countLoc())

    def test400_030_ShouldReturnLocCountValidationFD(self):
        itemToCompare = 9
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationFD.py").countLoc())
    
    def test400_040_ShouldReturnLocCountValidationHybrid(self):
        itemToCompare = 21
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationHybrid.py").countLoc())
    
    def test400_050_ShouldReturnLocCountValidationKeywords(self):
        itemToCompare = 0
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationKeywords.py").countLoc())
    
    def test400_060_ShouldReturnLocCountValidationNoComponents(self):
        itemToCompare = 6
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationNoComponents.py").countLoc())
    
    def test400_070_ShouldReturnLocCountValidationOO(self):
        itemToCompare = 12
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationOO.py").countLoc())
    
    def test400_080_ShouldReturnLocCountValidationRandom(self):
        itemToCompare = 100
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationRandom.py").countLoc())
    
    def test400_090_ShouldReturnLocCountValidationStrings(self):
        itemToCompare = 13
        self.assertEquals(itemToCompare, PythonScript.PythonScript("/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/validationStrings.py").countLoc())
...
# extractDesign
    ...
    def test500_010_ShouldReturnDesignTupleValidationComments(self):
        ...
        ooList = []
        fdList =[]
        pathName = "/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/"
...
#check for the correct fd information
    ...
    def test500_020_ShouldReturnDesignTupleValidationDocstrings(self):
        ...
        fdList =["docStringFunction1",1,2,"docStringFunctionB",1,2,"docStringFunctionC",1,2]
        pathName = "/Taylor/Desktop/softwareProcess/tzj0003/CA04/adam_test/CA03Validation/"
