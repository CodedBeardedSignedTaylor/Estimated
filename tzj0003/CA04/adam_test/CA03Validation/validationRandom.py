'''
    Validation Suite:  Random (and messy) code taken from the Internet
    Baselined:  NA
    Modified:  20 Oct 2014
    @author: http://code.activestate.com/recipes/577606-sms_encryption/?in=lang-python
          Component("det",1,24)
          Component("num",1,7)
          Component("what",1,26)
...
def encrypt(string):
    ...
    for chr in string:
        if chr==' ': # if you put number it pirnts space. 
            retstr+=' '
            continue
        list=what(chr)
